	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		OnCheckedChangeListener changeListener = new CompoundButton.OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if (isChecked) {
					Toast.makeText(SimpleComponentActivity.this, "选中了" + hobby,
							0).show();
				} else {
		...
		cb_simple_basket.setOnCheckedChangeListener(changeListener);
		cb_simple_foot.setOnCheckedChangeListener(changeListener);
		cb_simple_pingpang.setOnCheckedChangeListener(changeListener);
		...
		rg_simple_sex
				.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
					@Override
					public void onCheckedChanged(RadioGroup group, int checkedId) {// checkedId
																					// 选中的radioButton的id
						// 找到选中的radioButton
						...
						// 提示
						Toast.makeText(SimpleComponentActivity.this, sex, 0)
								.show();
					}
				});
	}

	// Button android:onClick="confirm"
